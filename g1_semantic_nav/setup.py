...
setup(
    ...
    entry_points={
        'console_scripts': [
            'semantic_viz = g1_semantic_nav.semantic_viz:main',
            'semantic_pipeline = g1_semantic_nav.semantic_pipeline:main',
            'nav_goal_server = g1_semantic_nav.nav_goal_server:main',
        ],
    },
)
